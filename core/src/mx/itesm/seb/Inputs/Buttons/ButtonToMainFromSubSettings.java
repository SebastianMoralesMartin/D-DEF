...
public class ButtonToMainFromSubSettings extends EnhancedTextButton {

    private EnhancedScreen screen;
    private InsertNameTextField insertNameTextField;

    public ButtonToMainFromSubSettings(Videogame videogame, EnhancedScreen screen, InsertNameTextField insertNameTextField, Skin skin) {
    ...
    public ButtonToMainFromSubSettings(Videogame videogame, EnhancedScreen screen, Skin skin, String styleName) {
    ...
    public ButtonToMainFromSubSettings(Videogame videogame, EnhancedScreen screen, TextButtonStyle style) {
